...
namespace EEU.Migrations
{
    ...
    [Migration("20230223061344_CodexRaw")]
    partial class CodexRaw
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EEU.Model.CodexEntry", b =>
                {
                    ...
                    SqlServerKeyBuilderExtensions.IsClustered(b.HasKey("ValueHash"), false);

                    b.ToTable("CodexEntries", t =>
                        {
                            t.HasCheckConstraint("CK_Value_ValidJson", "ISJSON([Value]) > 0");
                        });
                });
